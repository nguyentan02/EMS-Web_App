<template>
  <Menu as="div" class="relative inline-block text-left">
    ...
    >
      ...
      >
        <router-link
          :to="{ name: 'historytransfer' }"
          class="text-black inline-flex relative items-center mb-2 py-[10px] px-[10px] w-full text-base font-medium rounded-md border-gray-200 hover:bg-gray-300 hover:text-gray"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          Lịch sử luân chuyển</router-link
        >
