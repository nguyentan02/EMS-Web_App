  ...
  >
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <img
        ...
        src="https://cdn.pixabay.com/photo/2017/05/15/23/48/survey-2316468_1280.png"
        alt="Your Company"
      />
      <h2
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" @submit.prevent="submitLogin" method="POST">
        <div>
          <label
            for="email"
...
const submitLogin = async () => {
  ...
  if (userStore.roleFilter() === "admin") {
    router.push({ name: "users" });
  } else router.push({ name: "test" });
};
</script>
